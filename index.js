...
var PluginSettings = import_typebox.Type.Object({
  ...
  filePath: import_typebox.Type.Optional(
    import_typebox.Type.String({ description: "DEPRECATED. Use filePathPattern instead.", deprecated: true })
  ),
...
// ../../../../node_modules/.pnpm/guess-json-indent@2.0.0/node_modules/guess-json-indent/build/src/main.js
...
// src/parsing/serializeMessage.ts
  ...
  saveMessages: async ({ settings, nodeishFs, messages }) => {
    ...
    for (const [languageTag, messages2] of Object.entries(result)) {
      ...
      await nodeishFs.writeFile(
        ...
        (stringifyWithFormatting[languageTag] ?? // default to tab indentation
